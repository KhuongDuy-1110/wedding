    ...
    <section className="section-padding" style={{ background: "#fdfdfd" }}>
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: "40px", marginTop: "40px" }}>
        ...
        >
          ...
          <h3 className="font-brice" style={{ fontSize: "22px", margin: "20px 0 10px", color: "var(--primary)", letterSpacing: "1px" }}>
            Thứ Bảy - 04 Tháng 04
          </h3>
          ...
          <div style={{ borderTop: "1px solid #eee", paddingTop: "20px", marginBottom: "20px" }}>
            <div style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: "8px", marginBottom: "10px" }}>
              ...
              <span style={{ fontWeight: "700", fontSize: "15px" }}>Tạ Gia - Tư Gia Nhà Gái</span>
            </div>
          ...
          <a
            ...
            style={{ textDecoration: "none", maxWidth: "200px", margin: "0 auto", padding: "12px" }}
          >
        ...
        >
          ...
          <div style={{ borderTop: "1px solid #eee", paddingTop: "20px", marginBottom: "20px" }}>
            <div style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: "8px", marginBottom: "10px" }}>
              <MapPin size={18} color="var(--primary)" />
              <span style={{ fontWeight: "700", fontSize: "15px" }}>Tư Gia Nhà Trai</span>
            </div>
            <p style={{ fontSize: "13px", color: "#888", lineHeight: "1.6" }}>
